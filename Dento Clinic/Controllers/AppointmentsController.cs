...
namespace Dento_Clinic.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentId,PatientId,DentistId,AppointmentDate,AppointmentTime,Status")] Appointment appointment)
        {
            ...
            ViewBag.DentistId = new SelectList(db.Dentists, "DentistId", "Name", appointment.DentistId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentId,PatientId,DentistId,AppointmentDate,AppointmentTime,Status")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
